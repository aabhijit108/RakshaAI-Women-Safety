import { Bell, Check, ChevronRight, Globe, Info, ShieldCheck, X } from "lucide-react-native";
      ...
      >
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            <View style={[styles.iconBg, { backgroundColor: "#0a2e2a" }]}>
              <Globe size={20} color="#00C4B4" />
            </View>
            <Text style={styles.sectionTitle}>Voice Language</Text>
          </View>
          <Text style={styles.sectionSubtitle}>
            Select the language for AI voice commands and SOS triggers.
          </Text>
          {languages.map((lang) => (
            <TouchableOpacity
              key={lang}
            ...
            >
              ...
              {language === lang && <Check size={18} color="#00C4B4" />}
            </TouchableOpacity>
          ))}
        </View>
